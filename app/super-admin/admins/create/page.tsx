    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 font-serif">Create New Admin</h1>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                >
                  <option value="">Verification Admin</option>
      ...
      <NewAdminMailModal 
        ...
        email={formData.email || 'chisom@eventhub.com'}
      />
    </div>
  )
}
