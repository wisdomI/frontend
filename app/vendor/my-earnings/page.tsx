      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-sm border border-blue-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-blue-700 mb-1">Total Earnings</p>
                <p className="text-2xl font-bold text-blue-900">₦500,000.00</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl shadow-sm border border-orange-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-orange-700 mb-1">Pending Payout</p>
                <p className="text-2xl font-bold text-orange-900">₦100,000.00</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl shadow-sm border border-green-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-700 mb-1">Withdrawable Balance</p>
                <p className="text-2xl font-bold text-green-900">₦100,000.00</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2 pr-8 text-sm font-medium text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            {/* Earnings Chart */}
            <div className="h-64 bg-gray-50 rounded-lg p-6 relative">
              <svg width="100%" height="100%" viewBox="0 0 500 200" className="overflow-visible">
                ...
                {/* Data points */}
                <circle cx="70" cy="150" r="3" fill="#1e40af" />
                <circle cx="110" cy="80" r="3" fill="#1e40af" />
                <circle cx="150" cy="90" r="3" fill="#1e40af" />
                <circle cx="190" cy="50" r="3" fill="#1e40af" />
                <circle cx="230" cy="60" r="3" fill="#1e40af" />
                <circle cx="270" cy="40" r="3" fill="#1e40af" />
                <circle cx="310" cy="30" r="3" fill="#1e40af" />
                <circle cx="350" cy="25" r="3" fill="#1e40af" />
                <circle cx="390" cy="20" r="3" fill="#1e40af" />
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">612926972 - Access Bank</p>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {currentEarnings.map((earning) => (
                  <tr key={earning.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{earning.dateTime}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{earning.clientName}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{earning.serviceType}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{earning.amount}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-3 py-1 text-xs font-medium rounded-full border ${getStatusColor(earning.paymentStatus)}`}>
