...
export default function VerificationDashboard({ basePath = '/verification-admin' }: VerificationDashboardProps) {
  const stats = [
    { label: 'Pending Verifications', value: 24, color: 'text-[#EAB308]', border: 'border-[#EAB308]' },
    { label: 'Approved this week', value: 156, color: 'text-[#22C55E]', border: 'border-[#22C55E]' },
    { label: 'Rejected', value: 8, color: 'text-[#EF4444]', border: 'border-[#EF4444]' },
  ]

  const queue = [
    { id: 1, name: 'Royal Events Ltd', submitted: '2025-10-07', documents: 'CAC, ID Card', status: 'Pending' },
    { id: 2, name: 'UK Cakes & Cream', submitted: '2025-10-07', documents: 'CAC, ID Card', status: 'Pending' },
    { id: 3, name: 'Elite Catering', submitted: '2025-10-07', documents: 'CAC, ID Card', status: 'Approved' },
    { id: 4, name: 'DJ Lekzy Entertainment', submitted: '2025-10-07', documents: 'CAC, ID Card', status: 'Rejected' },
  ]
