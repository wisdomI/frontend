...
export default function AdminHeader({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  const displayName = user?.firstName || user?.businessName || user?.displayName || 'Admin'
          ...
          <div className="flex items-center justify-between h-20 gap-4 lg:gap-14">
            ...
            <div className="flex items-center gap-2 lg:gap-6">
              ...
              <div className="relative" ref={logoutRef}>
                ...
                >
                  {profilePicture ? (
                    <Image src={profilePicture} alt="Profile" width={48} height={48} className="rounded-full" />
                  ) : (
