      ...
      <div className="bg-white rounded-2xl w-full max-w-md mx-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-gray-900">Subscription Confirmation</h2>
          </div>
          <button onClick={onClose} className="p-1">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="text-center space-y-4">
            ...
            <div className="space-y-1">
              <p className="text-blue-600 font-medium">{planName} Plan</p>
              <p className="text-blue-600 font-medium">{billingCycle}</p>
            </div>
            ...
            {/* Payer Info */}
            <div className="space-y-1">
              <p className="text-blue-600 font-medium">{payerName}</p>
