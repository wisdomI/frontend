        ...
        {recommendations.map((item) => (
          <div key={item.id} className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
            ...
            />
              ...
              <p className="text-xs   p-4 font-sans text-gray-600 mb-3 leading-relaxed line-clamp-3">
                {item.description}
              </p>
              
              <div className="flex items-center gap-1 mb-2">
                <span className="text-xs font-heading font-medium p-4 text-gray-700">Rating:</span>
              ...
              <div className="flex p-4 items-center gap-1 text-xs text-gray-500 mb-2">
                <span>📍</span>
