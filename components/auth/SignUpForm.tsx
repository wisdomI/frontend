...
export default function SignUpModal({ onClose, onContinue, onLogin }: SignUpModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 mx-auto ml-0 animate-fadeIn">
