...
export default function SignUpModal({ onClose, onContinue, onLogin, accountType = 'individual' }: SignUpModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-50 rounded-2xl w-full h-full max-w-xl p-12 relative max-h-[96vh] overflow-y-auto">
        <button
          onClick={onClose}
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          {isOrganization ? (
            ...
            <>
              ...
              <div>
                <label className="block text-sm font-medium font-heading text-gray-700 mb-1">Business Email</label>
                <input
                  type="email"
              ...
              <div>
                <label className="block text-sm font-medium font-heading text-gray-700 mb-1">Business Address</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium font-heading text-gray-700 mb-1">Business Phone Number</label>
                <div className="flex">
            ...
            <>
              <div>
                <label className="block text-sm font-medium font-heading text-gray-700 mb-1">First Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-heading font-medium text-gray-700 mb-1">Last Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium font-heading text-gray-700 mb-1">Phone Number</label>
                <div className="flex">
                  <select className="border border-gray-300 rounded-l-lg px-3 py-2 bg-gray-50">
                    <option>🇳🇬 </option>
                  </select>
          ...
          <div className="relative">
            <label className="block text-sm font-medium font-heading text-gray-700 mb-1">New Password</label>
            <input
          ...
          <div className="relative">
            <label className="block text-sm font-medium font-heading text-gray-700 mb-1">Confirm Password</label>
            <input
        ...
        <div className="flex items-center mt-6 mb-4">
          ...
          <span className="mx-4 text-sm font-sans text-gray-500">Or Sign up with</span>
          <hr className="flex-1 border-event-blue" />
        </div>
