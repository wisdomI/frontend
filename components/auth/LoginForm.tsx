        ...
        <div className="bg-gray-50 rounded-2xl w-full max-w-lg p-12 relative max-h-[92vh] overflow-y-auto">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-event-blue focus:border-event-blue outline-none"
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full border border-gray-300 rounded-lg p-3 pr-12 focus:ring-2 focus:ring-event-blue focus:border-event-blue outline-none"
              />
              <button
                type="button"
          ...
          {/* Login Button */}
          <button className="w-full bg-event-blue text-white py-3 rounded-full hover:bg-blue-800 transition-colors font-medium mb-4">
            Login
          </button>
